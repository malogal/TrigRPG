...
var amplitude: float = 200 # Height of the wave
...
func _process(delta: float):
	...
	if debug_i % 50 == 0:
		...
		print_debug("local: ", get_local_mouse_position())

func _draw():
	draw_polyline(wave_points_positive, wave_color_pos, 2, true)
	draw_polyline(wave_points_negative, wave_color_neg, 2, true)
